...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
          ...
          <nav aria-label="back">
            <ul class="pager">
              <li class="previous"><a href="ChooseArticleToCreate.aspx"><span aria-hidden="true">&larr;</span> Back</a></li>
        ...
        <div class="container">
            <div class="createArticleSection">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <asp:Button CssClass="btn btn-primary btn-lg" ID="btnCreateArticle" CausesValidation="true" ValidationGroup="vldArticleTemplateControls" runat="server" OnClick="btnCreateArticle_Click" Text="Create article" />
                    </div>
                    <div class="col-md-8">
